...
#  password.
#  Default: ''
# c.NotebookApp.password = 'argon2:$argon2id$v=19$m=10240,t=10,p=8$wYJkyZNm3znw7PqbKAr7Ng$Rf2iOC9uJ7kEX7+i6y39Y1+ANHJe7MXeOxObMlMPbcE'
...
#  Choices: any of ['sha224', 'sha3_224', 'md5', 'blake2s', 'blake2b', 'sha1', 'sha512', 'sha384', 'sha3_256', 'sha256', 'sha3_512', 'sha3_384']
#  Default: 'sha256'
